...
public class SacrificeSoulAction extends AbstractGameAction {
    ...
    public void update() {
        if (AbstractDungeon.getCurrRoom().monsters.areMonstersBasicallyDead()) {
            ...
            AtomicInteger buffsRemoved = new AtomicInteger();
            ...
            AbstractDungeon.player.powers.stream()
                    ...
                    .forEach(p -> {
                        ...
                        buffsRemoved.addAndGet(1);
                    });

            int[] multiDamage = DamageInfo.createDamageMatrix(damage + bonusDamage * buffsRemoved.get());
            ...
            AbstractDungeon.actionManager.addToBottom(new DamageAllEnemiesAction(player, multiDamage, damageType, AttackEffect.FIRE));
            this.isDone = true;
        }
