...
public class FearPotion extends AbstractPotion {
    ...
    public static final Color LIQUID_COLOR = new Color(0xD13512);
    public static final Color HYBRID_COLOR = new Color(0xFFE6E6);
    public static final Color SPOTS_COLOR = new Color(0x64190A);
    public FearPotion() {
        // The bottle shape and inside is determined by potion size and color. The actual colors are the main TheForsakenMod.java
