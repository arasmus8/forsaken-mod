...
public class OldMantraPower extends AbstractForsakenPower implements CloneablePowerInterface {
    private static final String POWER_ID = TheForsakenMod.makeID(OldMantraPower.class.getSimpleName());
    ...
    public OldMantraPower(final AbstractCreature owner, int amount) {
    ...
    public AbstractPower makeCopy() {
        return new OldMantraPower(owner, amount);
    }
}
