...
public class OldRipostePower extends AbstractForsakenPower implements CloneablePowerInterface {
    private static final String POWER_ID = TheForsakenMod.makeID(OldRipostePower.class.getSimpleName());
    ...
    public OldRipostePower(final AbstractCreature owner) {
    ...
    public AbstractPower makeCopy() {
        return new OldRipostePower(owner);
    }
}
