...
public class ArmorOfThorns extends CustomRelic {
    ...
    public int onPlayerGainedBlock(float blockAmount) {
        if (blockAmount >= 1.0F) {
            ...
            AbstractDungeon.actionManager.addToBottom(new DamageAllEnemiesAction(null, DamageInfo.createDamageMatrix(3, true), DamageInfo.DamageType.THORNS, AbstractGameAction.AttackEffect.BLUNT_LIGHT));
        }
