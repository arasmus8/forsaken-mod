...
public abstract class AbstractOldForsakenCard extends CustomCard {
    ...
    public AbstractOldForsakenCard(final String id,
                                final int cost,
    ...
    private static String getBaseImagePath(String id) {
        return id.replaceAll(getModID() + ":oldcards:", "");
    }

    private static CustomCard.RegionName getRegionName(String id) {
        return new CustomCard.RegionName(String.format("%s/old/%s", getModID(), getBaseImagePath(id)));
    }
