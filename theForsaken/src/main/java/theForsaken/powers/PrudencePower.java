...
public class PrudencePower extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("prudence84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("prudence32.png"));
