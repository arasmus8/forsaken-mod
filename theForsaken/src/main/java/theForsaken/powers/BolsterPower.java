...
public class BolsterPower extends AbstractPower implements CloneablePowerInterface {
    private static final String POWER_ID = TheForsakenMod.makeID(BolsterPower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("bolster84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("bolster32.png"));
