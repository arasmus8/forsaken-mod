...
public class HumbleEggAbstractDungeonInsertPatch {

    private static final Logger logger = LogManager.getLogger(HumbleEggAbstractDungeonInsertPatch.class.getName());
