...
public class TextureLoader {
     ...
     *                      Example: "theForsakenResources/images/ui/missing_texture.png"
    ...
    public static Texture getTexture(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                ...
                return getTexture("theForsakenResources/images/ui/missing_texture.png");
            }
        }
